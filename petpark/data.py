...
ASSISTANT_TASKS: list[tuple[str, str, str, str]] = [
    ("修炼", "修炼/双修", "修炼（已婚自动转双修）", "pet"),
    ("进入副本", "进入副本", "进入副本（自动挑最高档）", "pet"),
    ("挑战神仙", "挑战神仙", "挑战神仙（自动挑最高档）", "pet"),
    ("外出历练", "外出历练", "外出历练（修士）", "cult"),
    ("秋冬Boss", "秋冬Boss", "当前活动 Boss", "pet"),
    ("深渊秘境", "深渊秘境", "深渊秘境", "pet"),
    ("宠物神仙劫", "神仙劫", "宠物神仙劫", "pet"),
    ("砸蛋", "砸蛋", "砸蛋", "pet"),
    ("砸蛋十连", "砸蛋十连", "砸蛋十连（与砸蛋共用冷却）", "pet"),
    ("打工", "打工", "打工", "pet"),
    ("学习", "学习", "学习", "pet"),
    ("洗髓", "洗髓", "洗髓", "pet"),
    ("探险", "探险", "探险", "pet"),
    ("冥想", "冥想", "冥想（需定制宠物）", "pet"),
    ("幻境寻宝", "幻境寻宝", "幻境寻宝（需飞升）", "pet"),
    ("家园收取", "家园收取", "家园收取", "pet"),
    ("约会", "约会", "道侣之约", "pet"),
    ("修士修炼", "修士修炼", "修士修炼（修士）", "cult"),
    ("修士突破", "修士突破", "修士突破（修士）", "cult"),
]
